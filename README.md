...
I would say that its a way to help people with disabilities have a better expirience using the web.

2. Talk about 3 different things you can do to ensure your website is accessible. 
you can use simantic html, use the alt tag for pictures and include a high contrast version control.
3. How would you explain the concept of a variable to someone new to programming?

A variable is something you use to store information and then use it somewhere else.

4. What is the purpose of using functions in code?

so that your code doesnt run all the time. the functions contain it till you are ready to use and makes it easier for you to reuse code
